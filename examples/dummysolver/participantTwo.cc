...
int main(int argc, char **argv)
{
    ...
    const std::string scalarDataWriteName = "scalarDataTwo";
    const std::string scalarDataReadName = "scalarDataOne";
    const std::string vectorDataWriteName = "vectorDataTwo";
    const std::string vectorDataReadName = "vectorDataOne";
    couplingParticipant.announceWriteQuantity(meshName, scalarDataWriteName);
    couplingParticipant.announceReadQuantity(meshName, scalarDataReadName);
    couplingParticipant.announceWriteQuantity(meshName, vectorDataWriteName);
    couplingParticipant.announceReadQuantity(meshName, vectorDataReadName);
